...
\begin{mathpar}
\inferrule*[Right=bool-intros-true]{ }{\Gamma \vdash \True : \Bool}
...
\begin{mathpar}
\inferrule*[Right=bool-comp-1]{\Gamma, b: \Bool \vdash D(b) \ \type, \ \Gamma \vdash f:D(\False), \ \Gamma \vdash t:D(\True)}{\Gamma \vdash \Ind_{\Bool}(f,t,\False) \defeq f : D(\False)}

\inferrule*[Right = bool-comp-2]{\Gamma, b: \Bool \vdash D(b) \ \type, \ \Gamma \vdash f:D(\False), \ \Gamma \vdash t:D(\True)}{\Gamma \vdash \Ind_{\Bool}(f,t,\True) \defeq t : D(\True)}
\end{mathpar}
...
{\Gamma , x : \N \vdash D(x) \ \type \\\\ \Gamma \vdash a : D(0) \\\\ \Gamma , x : \N , y : D(x) \vdash b : D(S x)}
{\Gamma , x : \N \vdash \text{ind}_{\N}(a,b,x) : D(x)}
\end{mathpar}
...
{\Gamma , x : \N \vdash D(x) \ \type \\\\ \Gamma \vdash a : D(0) \\\\ \Gamma , x : \N , y : D(x) \vdash b : D(S x)}
{\Gamma \vdash \text{ind}_{\N}(a,b,0) \defeq a : D(0)}
\and
\inferrule*[Right=Nat-comp-S]
{\Gamma , x : \N \vdash D(x) \ \type \\\\ \Gamma \vdash a : D(0) \\\\ \Gamma , x : \N , y : D(x) \vdash b : D(S x)}
{\Gamma, x : \N , \text{ind}_{\N}(a,b,S n) \defeq b[\sfrac{\text{ind}_{\N}(a,b,x)}{y}] : D(S n)}
\end{mathpar}
